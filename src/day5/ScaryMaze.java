...
int name = -1;
		...
		else if (mouseColor == -16711689) {
			showScaryImage("deadpool-pancakes.jpg"); JOptionPane.showMessageDialog(null, "you some what won"); 
		}
		else if (mouseColor == -16708097) {
			showScaryImage ("deadpool bro.jpg");
		}
		else if (mouseColor == -12449792) {
			showScaryImage ("deadpool batman.jpg");
		}
...
showScaryImage("deadpool brain.jpg");
	}
